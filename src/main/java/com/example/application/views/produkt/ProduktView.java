package com.example.application.views.produkt;
...
@RolesAllowed("admin")
public class ProduktView extends Div implements BeforeEnterObserver {
    ...
    public ProduktView(@Autowired SampleFoodProductService sampleFoodProductService) {
        this.sampleFoodProductService = sampleFoodProductService;
        addClassNames("produkt-view", "flex", "flex-col", "h-full");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(ProduktView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleFoodProductId.isPresent()) {
            ...
            if (sampleFoodProductFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(ProduktView.class);
            }
        }
    }
